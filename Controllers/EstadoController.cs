    ...
    public class EstadoController : Controller
    {
        ...
        public async Task<IActionResult> MiEstado()
        {
            ...
            var prestamoActivo = await _db.Prestamo
                ...
                // Se busca que sea ACTIVO O APROBADO, y que NO se haya devuelto aún (FechaFinReal == null)
                .Where(p => p.PersonaId == uid &&
                           (p.EstadoPrestamo == "ACTIVO" || p.EstadoPrestamo == "APROBADO") &&
                           p.FechaFinReal == null &&
                           p.Estado)
                // ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
        ...
        public async Task<IActionResult> MarcarDevuelto()
        {
            ...
            // Buscar préstamo activo del usuario para devolverlo
            // También aquí debemos asegurar que busque APROBADO o ACTIVO
            ...
            prestamo.Estado = false; // Opcional: depende de si quieres "borrarlo" lógicamente o solo cambiar su estado.
